...
As shown above, the odds ratio of solved cases for males victims is generally higher in all cities in our sample compared to the odds ratio of solved homicides for female victims. The odds ratio of solved homicides for males compared to females is highest in Albuquerque, NM: the OR for male victims is about twice the OR for female victims, while holding all other variables fixed. In contrast, the OR of solved cases between the two sexes is about 0 in New York, NY, while holding all other variables fixed. 
...
As shown above, the first and third model may be a better models because they have lower RMSE values. Model 1 is preferred because it's more simple than model 3 and it has a slightly lower RMSE value. 